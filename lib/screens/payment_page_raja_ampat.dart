...
void main() {
  runApp(MaterialApp(
    ...
    home: BookingPageRajaAmpat(),
  ));
}

class BookingPageRajaAmpat extends StatefulWidget {
  BookingPageRajaAmpat({Key? key}) : super(key: key);

  @override
  State<BookingPageRajaAmpat> createState() => _BookingPageState();
}

class _BookingPageState extends State<BookingPageRajaAmpat> {
  ...
  int _totalPrice = 127; // Harga total awal
  int _pricePerPerson = 127; // Harga per orang
