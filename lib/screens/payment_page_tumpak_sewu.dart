...
void main() {
  runApp(MaterialApp(
    ...
    home: BookingPageTumpakSewu(),
  ));
}

class BookingPageTumpakSewu extends StatefulWidget {
  BookingPageTumpakSewu({Key? key}) : super(key: key);

  @override
  State<BookingPageTumpakSewu> createState() => _BookingPageState();
}

class _BookingPageState extends State<BookingPageTumpakSewu> {
  ...
  int _totalPrice = 13; // Harga total awal
  int _pricePerPerson = 13; // Harga per orang
