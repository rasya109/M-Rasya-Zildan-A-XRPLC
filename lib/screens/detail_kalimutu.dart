...
import 'package:nusantaraa/screens/payment_page_kalimutu.dart';

void main() {
  runApp(DetailKalimutu());
}

class DetailKalimutu extends StatelessWidget {
  @override
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/background/background_kalimutu_crater.png"),
            fit: BoxFit.cover,
          ),
        ),
        child: Column(
        ...
        child: ElevatedButton(
          onPressed: () {
            // Tambahkan logika untuk tombol pada bagian bawah di sini
              Navigator.push(
    context,
    MaterialPageRoute(builder: (context) => BookingPageKalimutu()),
  );
          },
          child: Text(
            'Book a Trip',
        ...
        child: Column(
          ...
          children: [
            ...
            Align(
              alignment: Alignment.topLeft,
              child: Text(
              'Nestled on the mystical island of Flores, Indonesia, lies the enigmatic wonder of Kawah Kalimutu, a volcanic crater renowned for its ever-changing hues that paint the landscape with an ethereal beauty. Perched atop the rugged peaks of Mount Kelimutu, this geological marvel captivates visitors with its surreal allure and spiritual significance. As travelers',
                style: GoogleFonts.poppins(
                  fontSize: 16,
                ),
            ...
            Align(
              ...
              'embark on the journey to Kawah Kalimutu, they are greeted by the breathtaking scenery of Flores highlands, where lush forests give way to mist-shrouded mountainsides. Upon reaching the summit, they are met with a sight that defies imagination: three crater lakes, each with its own distinct color palette, nestled within the heart of the volcano.',
        ...
        itemBuilder: (context, index) {
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                image: AssetImage('assets/photos/kalimutu${index + 1}.jpg'),
                fit: BoxFit.cover,
              ),
            ),
          );
