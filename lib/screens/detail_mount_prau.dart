...
import 'package:nusantaraa/screens/payment_page_mount_prau.dart';

void main() {
  runApp(DetailMountPrau());
}

class DetailMountPrau extends StatelessWidget {
  @override
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/background/background_mount_prau.png"),
            fit: BoxFit.cover,
          ),
        ),
        child: Column(
        ...
        child: ElevatedButton(
          onPressed: () {
            // Tambahkan logika untuk tombol pada bagian bawah di sini
              Navigator.push(
    context,
    MaterialPageRoute(builder: (context) => BookingPageMountPrau()),
  );
          },
          child: Text(
            'Book a Trip',
        ...
        itemBuilder: (context, index) {
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                image: AssetImage('assets/photos/prau${index + 1}.jpg'),
                fit: BoxFit.cover,
              ),
            ),
          );
