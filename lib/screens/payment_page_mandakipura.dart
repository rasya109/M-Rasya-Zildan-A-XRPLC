...
void main() {
  runApp(MaterialApp(
    ...
    home: BookingPageMandakipura(),
  ));
}

class BookingPageMandakipura extends StatefulWidget {
  BookingPageMandakipura({Key? key}) : super(key: key);

  @override
  State<BookingPageMandakipura> createState() => _BookingPageState();
}

class _BookingPageState extends State<BookingPageMandakipura> {
  ...
  DateTime _selectedDate =
      DateTime.now(); // variabel untuk menyimpan tanggal yang dipilih
       int _totalPrice = 3; // Harga total awal
  int _pricePerPerson = 3; // Harga per orang
