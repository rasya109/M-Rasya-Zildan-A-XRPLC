...
import 'package:nusantaraa/screens/payment_page_aling.dart';

void main() {
  runApp(DetailAling());
}

class DetailAling extends StatelessWidget {
  @override
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/background/background_aling_aling.png"),
            fit: BoxFit.cover,
          ),
        ),
        child: Column(
        ...
        child: ElevatedButton(
          onPressed: () {
            // Tambahkan logika untuk tombol pada bagian bawah di sini
              Navigator.push(
    context,
    MaterialPageRoute(builder: (context) => BookingPageAling()),
  );
          },
          child: Text(
            'Book a Trip',
        ...
        child: Column(
          ...
          children: [
            ...
            Align(
              alignment: Alignment.topLeft,
              child: Text(
                'Aling-Aling Waterfall, nestled in the lush landscapes of Bali, Indonesia, is a hidden gem that enchants visitors with its natural beauty and serene surroundings. Tucked away in the village of Sambangan, this cascading masterpiece is a testament to Balis diverse and captivating topography. As you embark on the journey to Aling-Aling, the trek itself becomes a prelude to the enchantment that awaits. Lush',
                style: GoogleFonts.poppins(
                  fontSize: 16,
                ),
            ...
            Align(
              ...
              child: ExpandableText(
                ' greenery, vibrant tropical flora, and the soothing sounds of nature accompany you along the trail, creating a sense of tranquility that prepares you for the breathtaking spectacle ahead.',
        ...
        itemBuilder: (context, index) {
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                image: AssetImage('assets/photos/aling${index + 1}.jpg'),
                fit: BoxFit.cover,
              ),
            ),
          );
