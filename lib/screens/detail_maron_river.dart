...
import 'package:nusantaraa/screens/payment_page_maron_river.dart';

void main() {
  runApp(DetailMaronRiver());
}

class DetailMaronRiver extends StatelessWidget {
  @override
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/background/background_maron_river.png"),
            fit: BoxFit.cover,
          ),
        ),
        child: Column(
        ...
        child: ElevatedButton(
          onPressed: () {
            // Tambahkan logika untuk tombol pada bagian bawah di sini
              Navigator.push(
    context,
    MaterialPageRoute(builder: (context) => BookingPageMaronRiver()),
  );
          },
          child: Text(
            'Book a Trip',
        ...
        child: Column(
          ...
          children: [
            ...
            Align(
              alignment: Alignment.topLeft,
              child: Text(
              'Nestled amidst the verdant landscapes of Pacitan, East Java, Indonesia, flows the tranquil beauty of Sungai Maron, a meandering river that enchants visitors with its serene ambiance and natural splendor. Tucked away amidst lush forests and rugged terrain, this hidden gem offers a refreshing escape from the hustle and bustle of urban life. As travelers embark',
                style: GoogleFonts.poppins(
                  fontSize: 16,
                ),
            ...
            Align(
             ...
             'on the journey to Sungai Maron, they are greeted by the soothing sounds of flowing water and the rustle of leaves in the breeze. The air is cool and refreshing, carrying with it the faint scent of wildflowers and earth. The surrounding scenery is lush and vibrant, with towering trees providing shade along the riverbanks.',
        ...
        itemBuilder: (context, index) {
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                image: AssetImage('assets/photos/maronriver${index + 1}.jpg'),
                fit: BoxFit.cover,
              ),
            ),
          );
