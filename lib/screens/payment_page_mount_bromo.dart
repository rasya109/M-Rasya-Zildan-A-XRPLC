...
void main() {
  runApp(MaterialApp(
    ...
    home: BookingPageMountBromo(),
  ));
}

class BookingPageMountBromo extends StatefulWidget {
  BookingPageMountBromo({Key? key}) : super(key: key);

  @override
  State<BookingPageMountBromo> createState() => _BookingPageState();
}

class _BookingPageState extends State<BookingPageMountBromo> {
  ...
  DateTime _selectedDate =
      DateTime.now(); // variabel untuk menyimpan tanggal yang dipilih
       int _totalPrice = 4; // Harga total awal
  int _pricePerPerson = 4; // Harga per orang
  ...
  void _confirmBooking() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) => PaymentPage(uniqueCode: uniqueCode, totalPrice: _totalPrice)),
    );
  }
  ...
  String generateUniqueCode() {
    ...
    return "$randomCode\_$_selectedPackage\_$currentDate\_NTREXPR\_MntBrmo";
  }
}
