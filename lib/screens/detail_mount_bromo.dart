...
import 'package:nusantaraa/screens/payment_page_mount_bromo.dart';

void main() {
  runApp(DetailMountBromo());
}

class DetailMountBromo extends StatelessWidget {
  @override
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/background/background_mount_bromo.png"),
            fit: BoxFit.cover,
          ),
        ),
        child: Column(
        ...
        child: ElevatedButton(
          onPressed: () {
            // Tambahkan logika untuk tombol pada bagian bawah di sini
              Navigator.push(
    context,
    MaterialPageRoute(builder: (context) => BookingPageMountBromo()),
  );
          },
          child: Text(
            'Book a Trip',
        ...
        child: Column(
          ...
          children: [
            ...
            Align(
              alignment: Alignment.topLeft,
              child: Text(
                'Mount Bromo, a mesmerizing natural wonder nestled in the East Java region of Indonesia, stands as an awe-inspiring testament to the Earths breathtaking beauty. This iconic destination captivates the hearts of travelers with its surreal landscapes, dramatic vistas, and a unique blend of cultural richness. As the first light',
                style: GoogleFonts.poppins(
                  fontSize: 16,
                ),
            ...
            Align(
              ...
              child: ExpandableText(
                'of dawn breaks over the horizon, Mount Bromo unveils its ethereal charm, casting a spellbinding spectacle upon the surrounding Tengger Caldera. The iconic silhouette of the active volcano rises majestically amidst a sea of mist, creating a magical ambiance that transports visitors to another realm.',
        ...
        itemBuilder: (context, index) {
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                image: AssetImage('assets/photos/bromo${index + 1}.jpg'),
                fit: BoxFit.cover,
              ),
            ),
          );
