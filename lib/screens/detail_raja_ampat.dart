...
import 'package:nusantaraa/screens/payment_page_raja_ampat.dart';

void main() {
  runApp(DetailRaja());
}

class DetailRaja extends StatelessWidget {
  @override
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/detail_raja.jpg"),
            fit: BoxFit.cover,
          ),
        ),
        child: Column(
      ...
      bottomNavigationBar: Padding(
        ...
        child: ElevatedButton(
          onPressed: () {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => BookingPageRajaAmpat()),
            );
          },
          child: Text(
            'Book a Trip',
        ...
        child: Column(
          ...
          children: [
            ...
            Align(
              alignment: Alignment.topLeft,
              child: Text(
                'Raja Ampat is a renowned tourist destination in Indonesia, located in the West Papua province. The name "Raja Ampat" itself comes from the local language, meaning "Four Kings," referring to the four main islands that characterize this region, namely Waigeo, Salawati, Batanta, And Misool. The beauty of the',
                style: GoogleFonts.poppins(
                  fontSize: 16,
                ),
            ...
            Align(
              ...
              child: ExpandableText(
                'underwater world in Raja Ampat makes it a paradise for divers and marine life enthusiasts. The spectacular coral reefs, extraordinary marine biodiversity, and vibrant colors of tropical fish make the waters of Raja Ampat one of the best in the world. There are many amazing diving spots, such as Misool, Wayag, and Dampier Strait, offering unforgettable diving experiences.',
        ...
        itemBuilder: (context, index) {
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                image: AssetImage('assets/photos/raja${index + 1}.jpg'),
                fit: BoxFit.cover,
              ),
            ),
          );
