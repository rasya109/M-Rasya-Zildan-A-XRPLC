...
import 'package:nusantaraa/screens/detail_aling.dart';
import 'package:nusantaraa/screens/detail_jagir.dart';
import 'package:nusantaraa/screens/detail_mandakipura.dart';
import 'package:nusantaraa/screens/detail_tumpak_sewu.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: SearchWaterfall(),
    );
  }
}

class SearchWaterfall extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
  ...
  child: ListView.builder(
    ...
    itemBuilder: (context, index) {
      return GestureDetector(
          ...
          switch (index) {
            case 0:
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => DetailTumpakSewu(),
                ),
              );
              break;
            case 1:
            ...
            case 3:
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => DetailMandakipura(),
                ),
              );
              break;
            default:
        ...
        child: ListTile(
          title: Image.asset(
            'assets/waterfall${index + 1}.png', // Ganti dengan nama gambar yang sesuai
            fit: BoxFit.cover,
