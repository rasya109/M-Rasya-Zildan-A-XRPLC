...
void main() {
  runApp(MaterialApp(
    ...
    home: BookingPageMountRinajani(),
  ));
}

class BookingPageMountRinajani extends StatefulWidget {
  BookingPageMountRinajani({Key? key}) : super(key: key);

  @override
  State<BookingPageMountRinajani> createState() => _BookingPageState();
}

class _BookingPageState extends State<BookingPageMountRinajani> {
