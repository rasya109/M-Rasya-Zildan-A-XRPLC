...
void main() {
  runApp(MaterialApp(
    ...
    home: BookingPageAyungRiver(),
  ));
}

class BookingPageAyungRiver extends StatefulWidget {
  BookingPageAyungRiver({Key? key}) : super(key: key);

  @override
  State<BookingPageAyungRiver> createState() => _BookingPageState();
}

class _BookingPageState extends State<BookingPageAyungRiver> {
  ...
  int _totalPrice = 30; // Harga total awal
  int _pricePerPerson = 30; // Harga per orang
