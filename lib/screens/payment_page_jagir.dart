...
void main() {
  runApp(MaterialApp(
    ...
    home: BookingPageJagir(),
  ));
}

class BookingPageJagir extends StatefulWidget {
  BookingPageJagir({Key? key}) : super(key: key);

  @override
  State<BookingPageJagir> createState() => _BookingPageState();
}

class _BookingPageState extends State<BookingPageJagir> {
