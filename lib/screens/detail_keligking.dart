...
import 'package:nusantaraa/screens/payment_page_kelingking.dart';

void main() {
  runApp(DetailKelingking());
}

class DetailKelingking extends StatelessWidget {
  @override
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/background/background_kelingking_beach.png"),
            fit: BoxFit.cover,
          ),
        ),
        child: Column(
        ...
        child: ElevatedButton(
          onPressed: () {
            // Tambahkan logika untuk tombol pada bagian bawah di sini
              Navigator.push(
    context,
    MaterialPageRoute(builder: (context) => BookingPageKelingking()),
  );
          },
          child: Text(
            'Book a Trip',
        ...
        child: Column(
          ...
          children: [
            ...
            Align(
              alignment: Alignment.topLeft,
              child: Text(
              'Nestled along the rugged coastline of Nusa Penida, an island paradise off the coast of Bali, Indonesia, lies the awe-inspiring beauty of Kelingking Beach. This hidden gem, also known as T-Rex Beach due to the shape of its cliff resembling a Tyrannosaurus Rex, offers visitors a glimpse into a world of untouched natural splendor and unparalleled panoramic vistas. As travelers make their way down',
                style: GoogleFonts.poppins(
                  fontSize: 16,
                ),
            ...
            Align(
             ...
             'the winding paths that lead to Kelingking Beach, they are greeted by the sight of towering limestone cliffs that plunge dramatically into the azure waters below. The sheer magnitude of the landscape is awe-inspiring, evoking a sense of wonder and reverence for the power of nature.',
        ...
        itemBuilder: (context, index) {
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                image: AssetImage('assets/photos/kelingking${index + 1}.jpg'),
                fit: BoxFit.cover,
              ),
            ),
          );
