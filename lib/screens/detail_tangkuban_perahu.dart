...
import 'package:nusantaraa/screens/payment_page_tangkuban_perahu.dart';

void main() {
  runApp(DetailPageTangkubanPerahu());
}

class DetailPageTangkubanPerahu extends StatelessWidget {
  @override
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/background/background_tangkuban_perahu.png"),
            fit: BoxFit.cover,
          ),
        ),
        child: Column(
      ...
      bottomNavigationBar: Padding(
        ...
        child: ElevatedButton(
          onPressed: () {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => BookingPageTangkubanPerahu()),
            );
          },
          child: Text(
            'Book a Trip',
        ...
        child: Column(
          ...
          children: [
            ...
            Align(
              alignment: Alignment.topLeft,
              child: Text(
                'Tangkuban Perahu, an iconic natural wonder situated in West Java, Indonesia, is a captivating destination renowned for its striking volcanic landscape and rich cultural significance. Its name, which translates to "overturned boat" in Sundanese, is derived from the crater distinctive shape, resembling an upturned hull of a traditional boat. As travelers',
                style: GoogleFonts.poppins(
                  fontSize: 16,
                ),
            ...
            Align(
              ...
              child: ExpandableText(
                'venture towards Tangkuban Perahu, they are greeted by the sight of verdant tea plantations and lush forests that cloak the surrounding hillsides. The journey to the crater rim is accompanied by panoramic views of the Bandung Basin, adding to the anticipation of what lies ahead.',
        ...
        itemBuilder: (context, index) {
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                image: AssetImage('assets/photos/tangkuban${index + 1}.jpg'),
                fit: BoxFit.cover,
              ),
            ),
          );
