...
void main() {
  runApp(MaterialApp(
    ...
    home: BookingPageSumberMaron(),
  ));
}

class BookingPageSumberMaron extends StatefulWidget {
  BookingPageSumberMaron({Key? key}) : super(key: key);

  @override
  State<BookingPageSumberMaron> createState() => _BookingPageState();
}

class _BookingPageState extends State<BookingPageSumberMaron> {
  ...
  int _totalPrice = 1; // Harga total awal
  int _pricePerPerson = 1; // Harga per orang
