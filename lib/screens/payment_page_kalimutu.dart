...
void main() {
  runApp(MaterialApp(
    ...
    home: BookingPageKalimutu(),
  ));
}

class BookingPageKalimutu extends StatefulWidget {
  BookingPageKalimutu({Key? key}) : super(key: key);

  @override
  State<BookingPageKalimutu> createState() => _BookingPageState();
}

class _BookingPageState extends State<BookingPageKalimutu> {
  ...
  int _totalPrice = 7; // Harga total awal
  int _pricePerPerson = 7; // Harga per orang
