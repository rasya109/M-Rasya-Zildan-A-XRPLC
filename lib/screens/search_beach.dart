...
import 'package:nusantaraa/screens/detail_balekambang.dart';
import 'package:nusantaraa/screens/detail_keligking.dart';
...
class SearchBeach extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
  ...
  child: ListView.builder(
    ...
    itemBuilder: (context, index) {
      return GestureDetector(
          ...
          switch (index) {
            ...
            case 2:
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => DetailKelingking(),
                ),
              );
              break;
            case 3:
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => DetailBalekambang(),
                ),
              );
              break;
            default:
        ...
        child: ListTile(
          title: Image.asset(
            'assets/beach${index + 1}.png', // Ganti dengan nama gambar yang sesuai
            fit: BoxFit.cover,
