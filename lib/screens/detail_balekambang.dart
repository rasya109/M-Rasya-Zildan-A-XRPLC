...
import 'package:nusantaraa/screens/payment_page_balekambang.dart';

void main() {
  runApp(DetailBalekambang());
}

class DetailBalekambang extends StatelessWidget {
  @override
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/background/background_balekambang.png"),
            fit: BoxFit.cover,
          ),
        ),
        child: Column(
        ...
        child: ElevatedButton(
          onPressed: () {
            // Tambahkan logika untuk tombol pada bagian bawah di sini
              Navigator.push(
    context,
    MaterialPageRoute(builder: (context) => BookingPageBalekambang()),
  );
          },
          child: Text(
            'Book a Trip',
        ...
        child: Column(
          ...
          children: [
            ...
            Align(
              alignment: Alignment.topLeft,
              child: Text(
              'Balekambang, nestled along the southern coast of Malang in East Java, Indonesia, is a coastal gem that beckons visitors with its pristine shores, panoramic vistas, and cultural allure. This enchanting beach, surrounded by lush hills and blessed with a serene ambiance, offers a perfect blend of natural beauty and cultural richness.',
                style: GoogleFonts.poppins(
                  fontSize: 16,
                ),
            ...
            Align(
              ...
              child: ExpandableText(
               'As the gentle waves of the Indian Ocean caress the golden sands, Pantai Balekambang unfolds its picturesque panorama. Three small islands, named Ismoyo, Anoman, and Wisanggeni, stand as sentinels just offshore, creating a distinctive silhouette against the horizon. These islands are accessible by a scenic suspension bridge, adding an element of adventure to the visit.',
        ...
        itemBuilder: (context, index) {
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                image: AssetImage('assets/photos/balekambang${index + 1}.jpg'),
                fit: BoxFit.cover,
              ),
            ),
          );
