...
import 'package:nusantaraa/screens/payment_page_ijen.dart';

void main() {
  runApp(DetailIjen());
}

class DetailIjen extends StatelessWidget {
  @override
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/background/background_ijen_crater.png"),
            fit: BoxFit.cover,
          ),
        ),
        child: Column(
        ...
        child: ElevatedButton(
          onPressed: () {
            // Tambahkan logika untuk tombol pada bagian bawah di sini
              Navigator.push(
    context,
    MaterialPageRoute(builder: (context) => BookingPageIjen()),
  );
          },
          child: Text(
            'Book a Trip',
        ...
        child: Column(
          ...
          children: [
            ...
            Align(
              alignment: Alignment.topLeft,
              child: Text(
                'Nestled amidst the verdant landscapes of Banyuwangi, East Java, Indonesia, lies the enchanting Kawah Ijen, a volcanic crater renowned for its ethereal beauty and otherworldly phenomena. This captivating destination offers visitors a glimpse into the raw power of nature and the unique cultural tapestry of the region. At the break of dawn, adventurers embark on a',
                style: GoogleFonts.poppins(
                  fontSize: 16,
                ),
            ...
            Align(
              ...
              'journey to the summit of Kawah Ijen, guided by the soft glow of their headlamps and the promise of a breathtaking sunrise. As they ascend the rugged slopes of the volcano, the air is filled with anticipation, mingled with the faint scent of sulfur that hangs in the misty morning air.',
        ...
        itemBuilder: (context, index) {
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                image: AssetImage('assets/photos/ijen${index + 1}.jpg'),
                fit: BoxFit.cover,
              ),
            ),
          );
