...
void main() {
  runApp(MaterialApp(
    ...
    home: BookingPageAling(),
  ));
}

class BookingPageAling extends StatefulWidget {
  BookingPageAling({Key? key}) : super(key: key);

  @override
  State<BookingPageAling> createState() => _BookingPageState();
}

class _BookingPageState extends State<BookingPageAling> {
  ...
  DateTime _selectedDate =
      DateTime.now(); // variabel untuk menyimpan tanggal yang dipilih
       int _totalPrice = 10; // Harga total awal
  int _pricePerPerson = 10; // Harga per orang
