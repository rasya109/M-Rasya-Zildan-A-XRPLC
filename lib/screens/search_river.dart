...
import 'package:nusantaraa/screens/detail_goa_pindul.dart';
import 'package:nusantaraa/screens/detail_maron_river.dart';
import 'package:nusantaraa/screens/detail_sumber_maron.dart';
...
class SearchRiver extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
  ...
  child: ListView.builder(
    ...
    itemBuilder: (context, index) {
      return GestureDetector(
          ...
          switch (index) {
            case 0:
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => DetailGoaPindul(),
                ),
              );
              break;
            case 1:
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => DetailSumberMaron(),
                ),
              );
              break;
            case 2:
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => DetailMaronRiver(),
                ),
              );
              break;
            case 3:
        ...
        child: ListTile(
          title: Image.asset(
            'assets/river${index + 1}.png', // Ganti dengan nama gambar yang sesuai
            fit: BoxFit.cover,
