...
void main() {
  runApp(MaterialApp(
    ...
    home: BookingPageBalekambang(),
  ));
}

class BookingPageBalekambang extends StatefulWidget {
  BookingPageBalekambang({Key? key}) : super(key: key);

  @override
  State<BookingPageBalekambang> createState() => _BookingPageState();
}

class _BookingPageState extends State<BookingPageBalekambang> {
  ...
  DateTime _selectedDate =
      ...
      int _totalPrice = 2; // Harga total awal
  int _pricePerPerson = 2; // Harga per orang
