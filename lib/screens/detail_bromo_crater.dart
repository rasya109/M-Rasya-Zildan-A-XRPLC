...
import 'package:nusantaraa/screens/payment_page_bromo_crater.dart';

void main() {
  runApp(DetailBromoCrater());
}

class DetailBromoCrater extends StatelessWidget {
  @override
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/background/background_bromo_crater.png"),
            fit: BoxFit.cover,
          ),
        ),
        child: Column(
        ...
        child: ElevatedButton(
          onPressed: () {
            // Tambahkan logika untuk tombol pada bagian bawah di sini
              Navigator.push(
    context,
    MaterialPageRoute(builder: (context) => BookingPageBromoCrater()),
  );
          },
          child: Text(
            'Book a Trip',
        ...
        child: Column(
          ...
          children: [
            ...
            Align(
              alignment: Alignment.topLeft,
              child: Text(
              'Nestled within the enchanting landscape of East Java, Indonesia, lies the captivating Bromo Crater. This geological marvel, part of the Bromo Tengger Semeru National Park, stands as a testament to the raw power and beauty of nature. As the first light of dawn breaks over the horizon, visitors are greeted with a scene straight out of a dream. The soft hues of the morning sky provide the perfect backdrop to the dramatic silhouette of Mount Bromo, a towering presence against the misty surroundings. The air is crisp and invigorating, filled with the faint scent of sulfur from the volcanic activity',
                style: GoogleFonts.poppins(
                  fontSize: 16,
                ),
            ...
            Align(
              ...
              child: ExpandableText(
               'below. Descending into the vast caldera, travelers find themselves immersed in a lunar-like landscape unlike any other. The barren expanse is dotted with pockets of emerald green vegetation, creating a striking contrast against the ashen terrain. Wisps of steam rise from the depths of the crater, a reminder of the restless energy that simmers beneath the surface.',
        ...
        itemBuilder: (context, index) {
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                image: AssetImage('assets/photos/bromocrater${index + 1}.jpg'),
                fit: BoxFit.cover,
              ),
            ),
          );
