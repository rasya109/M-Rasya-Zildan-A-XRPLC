...
void main() {
  runApp(MaterialApp(
    ...
    home: BookingPageIjen(),
  ));
}

class BookingPageIjen extends StatefulWidget {
  BookingPageIjen({Key? key}) : super(key: key);

  @override
  State<BookingPageIjen> createState() => _BookingPageState();
}

class _BookingPageState extends State<BookingPageIjen> {
