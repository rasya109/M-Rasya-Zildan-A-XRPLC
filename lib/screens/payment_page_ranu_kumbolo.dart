...
void main() {
  runApp(MaterialApp(
    ...
    home: BookingPageRanuKumbolo(),
  ));
}

class BookingPageRanuKumbolo extends StatefulWidget {
  BookingPageRanuKumbolo({Key? key}) : super(key: key);

  @override
  State<BookingPageRanuKumbolo> createState() => _BookingPageState();
}

class _BookingPageState extends State<BookingPageRanuKumbolo> {
  ...
  int _totalPrice = 11; // Harga total awal
  int _pricePerPerson = 11; // Harga per orang
