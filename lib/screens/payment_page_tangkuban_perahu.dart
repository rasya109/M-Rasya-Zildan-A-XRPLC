...
void main() {
  runApp(MaterialApp(
    ...
    home: BookingPageTangkubanPerahu(),
  ));
}

class BookingPageTangkubanPerahu extends StatefulWidget {
  BookingPageTangkubanPerahu({Key? key}) : super(key: key);

  @override
  State<BookingPageTangkubanPerahu> createState() => _BookingPageState();
}

class _BookingPageState extends State<BookingPageTangkubanPerahu> {
