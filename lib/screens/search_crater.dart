...
import 'package:nusantaraa/screens/detail_bromo_crater.dart';
import 'package:nusantaraa/screens/detail_ijen.dart';
import 'package:nusantaraa/screens/detail_kalimutu.dart';
import 'package:nusantaraa/screens/detail_tangkuban_perahu.dart';
...
class SearchCrater extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
  ...
  child: ListView.builder(
    ...
    itemBuilder: (context, index) {
      return GestureDetector(
          ...
          switch (index) {
            ...
            case 2:
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => DetailPageTangkubanPerahu(),
                ),
              );
              break;
            case 3:
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => DetailBromoCrater(),
                ),
              );
              break;
            default:
        ...
        child: ListTile(
          title: Image.asset(
            'assets/crater${index + 1}.png', // Ganti dengan nama gambar yang sesuai
            fit: BoxFit.cover,
