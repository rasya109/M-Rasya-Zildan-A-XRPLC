...
void main() {
  runApp(MaterialApp(
    ...
    home: BookingPageGoaPindul(),
  ));
}

class BookingPageGoaPindul extends StatefulWidget {
  BookingPageGoaPindul({Key? key}) : super(key: key);

  @override
  State<BookingPageGoaPindul> createState() => _BookingPageState();
}

class _BookingPageState extends State<BookingPageGoaPindul> {
