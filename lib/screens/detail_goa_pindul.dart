...
import 'package:nusantaraa/screens/payment_page_goa_pindul.dart';

void main() {
  runApp(DetailGoaPindul());
}

class DetailGoaPindul extends StatelessWidget {
  @override
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/background/background_goa_pindul.png"),
            fit: BoxFit.cover,
          ),
        ),
        child: Column(
        ...
        child: ElevatedButton(
          onPressed: () {
            // Tambahkan logika untuk tombol pada bagian bawah di sini
              Navigator.push(
    context,
    MaterialPageRoute(builder: (context) => BookingPageGoaPindul()),
  );
          },
          child: Text(
            'Book a Trip',
        ...
        child: Column(
          ...
          children: [
            ...
            Align(
              alignment: Alignment.topLeft,
              child: Text(
                'Nestled amidst the lush landscapes of Yogyakarta, Indonesia, lies the hidden gem of Goa Pindul, a mystical underground river cave waiting to be explored. This captivating destination offers a unique and thrilling adventure for travelers seeking to immerse themselves in the wonders of nature. Embarking on a',
                style: GoogleFonts.poppins(
                  fontSize: 16,
                ),
            ...
            Align(
              ...
              child: ExpandableText(
                'journey into the depths of Goa Pindul, adventurers are greeted by the cool embrace of darkness, punctuated only by the soft glow of their headlamps. As they float on inner tubes along the crystal-clear waters of the underground river, a sense of wonder washes over them, transporting them to a realm untouched by time.',
        ...
        itemBuilder: (context, index) {
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                image: AssetImage('assets/photos/goapindul${index + 1}.jpg'),
                fit: BoxFit.cover,
              ),
            ),
          );
