...
import 'package:nusantaraa/screens/payment_page_mandakipura.dart';

void main() {
  runApp(DetailMandakipura());
}

class DetailMandakipura extends StatelessWidget {
  @override
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/background/background_mandakipura.png"),
            fit: BoxFit.cover,
          ),
        ),
        child: Column(
        ...
        child: ElevatedButton(
          onPressed: () {
            // Tambahkan logika untuk tombol pada bagian bawah di sini
              Navigator.push(
    context,
    MaterialPageRoute(builder: (context) => BookingPageMandakipura()),
  );
          },
          child: Text(
            'Book a Trip',
        ...
        child: Column(
          ...
          children: [
            ...
            Align(
              alignment: Alignment.topLeft,
              child: Text(
              'Nestled within the lush jungles of Probolinggo, East Java, Indonesia, lies the captivating Mandakipura Waterfall, a majestic cascade that enchants visitors with its pristine beauty and tranquil ambiance. Tucked away amidst verdant foliage and rugged terrain, this hidden gem offers a refreshing escape from the hustle and bustle of urban life. As travelers ',
                style: GoogleFonts.poppins(
                  fontSize: 16,
                ),
            ...
            Align(
             ...
             'venture into the heart of Probolinggo countryside, the sound of rushing water grows louder, signaling their approach to Mandakipura Waterfall. Emerging from the dense foliage, they are greeted by the breathtaking sight of water cascading gracefully down rocky cliffs, creating a mesmerizing display of natural splendor.',
        ...
        itemBuilder: (context, index) {
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                image: AssetImage('assets/photos/mandakipura${index + 1}.jpg'),
                fit: BoxFit.cover,
              ),
            ),
          );
